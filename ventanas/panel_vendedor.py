...
class EPPanelVendedor:
    ...
    def EPconstruirHeader(self):
        ...
        tk.Label(
            ...
            bg=EPCOLOR_HEADER, fg="white", font=("Arial", 16, "bold")).pack(side="left",padx=25,pady=18)
        ...
        EPBotonRedondeado(
            ...
            EPcolorFondo=EPCOLOR_BOTON_PRIMARIO, EPancho=120, EPalto=34).pack(side="right", padx=(15, 0))
        EPBotonRedondeado(
        ...
        EPBotonRedondeado(
            ...
            EPcolorFondo=EPCOLOR_BOTON_NEUTRO,EPancho=130, EPalto=34).pack(side="right",padx=5)

        EPBotonRedondeado(EPbotonesFrame, "Produccion", self.EPmostrarProduccion,
            EPcolorFondo=EPCOLOR_BOTON_NEUTRO,EPancho=110, EPalto=34).pack(side="right", padx=5)
    ...
    def EPmostrarProduccion(self):
        ...
        EPBotonRedondeado(
            ...
            EPcolorFondo=EPCOLOR_BOTON_EXITO).pack(pady=5)
        tk.Label(EPtarjetaFormulario,
            text="Nota: si el producto ya tiene\nproduccion registrada hoy, se\nreemplaza por la nueva cantidad.",
            bg=EPCOLOR_TARJETA, fg="#8B7A6A", font=("Arial", 8),justify="left").pack(anchor="w",pady=(20,0))
        ...
        tk.Label(EPtarjetaVentas,text="Ventas de hoy (todos los productos)",bg=EPCOLOR_TARJETA,
            fg=EPCOLOR_TEXTO,font=("Arial", 11,"bold")).pack(anchor="w",pady=(0, 8))
    ...
    def EPmostrarRegistrarVenta(self):# registrar una venta de mostrador 
        self.EPlimpiarVista()
        EPtarjeta=tk.Frame(self.EPcontenedorVista, bg=EPCOLOR_TARJETA,padx=25,pady=25)
        EPtarjeta.pack(padx=20,pady=20, anchor="n")
        tk.Label(EPtarjeta,text="Registrar venta en mostrador",bg=EPCOLOR_TARJETA,
            fg=EPCOLOR_TEXTO, font=("Arial",13, "bold")).pack(anchor="w", pady=(0, 15))
        ...
        self.EPetiquetaDisponible = tk.Label(EPtarjeta, text="Disponible hoy: -",bg=EPCOLOR_TARJETA, fg="#8B7A6A", font=("Arial",9))
        ...
        EPBotonRedondeado(EPtarjeta, "Registrar venta",self.EPconfirmarVentaManual,
            EPcolorFondo=EPCOLOR_BOTON_EXITO).pack(pady=5)
        tk.Label(EPtarjeta,
    ...
    def EPmostrarMisReportes(self):# mis reportes 
        self.EPlimpiarVista()
    ...
    def EPcrearTarjetaResumen(self, EPpadre, EPtitulo, EPvalorInicial):
        ...
        tk.Label(EPtarjeta,text=EPtitulo, bg=EPCOLOR_TARJETA, fg="#8B7A6A", font=("Arial", 9)).pack(anchor="w")
