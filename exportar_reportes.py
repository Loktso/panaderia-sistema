#modulo que arma los archivos de reporte (PDF y Excel) a partir de una
#lista de ventas ya consultadas. cada venta llega como un diccionario con:
#fecha_hora, nombre_producto, nombre_vendedor, cantidad, total
#(esos diccionarios vienen de base_datos.EPobtenerVentasDetalladas)
...
#arma un PDF con una tabla de las ventas recibidas mas un total al final.
#EPruta es la ruta completa donde se va a guardar el archivo (el usuario
#la elige desde un dialogo "guardar como" en panel_admin.py)
...
#arma un archivo Excel con una hoja "Ventas", encabezados en negrita con
#el color cafe del proyecto, y una fila de total al final
